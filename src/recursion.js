...
var arraySum = function(array) {
    var arrayCopy = array.slice().flat(Infinity);
...
var range = function(x, y) {
    ...
    x < y ? result.push(x + 1) : result.push(x - 1);

    return x < y ? (result.concat(range(x + 1, y))) : (result.concat(range(x - 1, y)));
